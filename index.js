// ഇതാണ് 'index.js' ഫയൽ.
// *** കാറ്റഗറി സ്ലൈഡർ പ്രവർത്തിപ്പിക്കാനുള്ള കോഡ് ചേർത്തു ***
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    loadHeroSlider();
    loadTopSellers();
    loadHomeCategories(); // <-- കാറ്റഗറി സ്ലൈഡർ ഇവിടെ തുടങ്ങും
});
...
async function loadTopSellers() {
    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            card.className = 'swiper-slide'; // <-- ഇത് swiper-slide ആണ്
        ...
        new Swiper('.top-sellers-swiper-new', {
            ...
            breakpoints: { 640: { slidesPerView: 2 }, 900: { slidesPerView: 4 }, 1200: { slidesPerView: 4 } }
        });
...
async function loadHomeCategories() {
    ...
    try {
        ...
        catSnapshot.forEach((doc) => {
            ...
            // *** 'swiper-slide' എന്ന ക്ലാസ് ചേർക്കുന്നു ***
        ...
        // *** പുതിയ കാറ്റഗറി സ്ലൈഡർ പ്രവർത്തിപ്പിക്കുന്നു ***
        new Swiper('.category-swiper-new', {
            loop: true,
            autoplay: {
                delay: 2500, // 2.5 സെക്കൻഡ്
                disableOnInteraction: false,
            },
            slidesPerView: 3, // മൊബൈലിൽ 3 എണ്ണം
            spaceBetween: 15,
            breakpoints: {
                // വലിയ സ്ക്രീനിൽ കൂടുതൽ കാണിക്കുന്നു
