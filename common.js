// common.js - Handles Header, Footer, and Preloader
...
export async function loadSiteSettings() {
    ...
    // ഡോട്ടുകൾക്കുള്ള HTML ചേർക്കുന്നു
    const loaderRing = document.querySelector('.loader-ring');
    if (loaderRing) {
        loaderRing.className = 'loader-dots'; // ക്ലാസ് മാറ്റുന്നു
