// common.js - With 3-Second Loading for Home Page
...
export async function loadSiteSettings() {
    ...
    try {
        ...
        if (preloader) {
            // Check if current page is Home (index.html or root)
            const isHomePage = window.location.pathname.endsWith('index.html') || window.location.pathname.endsWith('/');
            const delay = isHomePage ? 3000 : 500; // 3 seconds for home, 0.5s for others
