// common.js - Updated: Desktop Header Align, 4-Column Footer
...
async function buildFooter() {
    ...
    const companyName = settings.logoText ? settings.logoText : 'JR UD HUB';
    const copyRightHTML = `<p>&copy; ${year} ${companyName}. All Rights Reserved.</p>`;
    ...
    // Footer HTML Structure - 4 Columns for Desktop
    footerElement.innerHTML = `
        <div class="footer-container-new">
            
            <!-- Column 1: About / Brand -->
            <div class="footer-col brand-col">
                <div class="footer-brand-title">${companyName}</div>
                <p class="footer-desc">Your one-stop destination for quality products. We ensure the best shopping experience.</p>
            </div>

            <!-- Column 2: Quick Links (Accordion on Mobile) -->
            <div class="footer-accordion-item footer-col">
            ...
            <!-- Column 3: Policies (Accordion on Mobile) -->
            <div class="footer-accordion-item footer-col">
                <button type="button" class="footer-accordion-toggle" data-target="footer-content-2">
                    <span>POLICIES</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"><path fill-rule="evenodd" d="M8 11.293l-4.646-4.647a.5.5 0 0 1 .708-.708L8 9.879l4.939-4.939a.5.5 0 0 1 .708.708L8 11.293z"></path></svg>
                </button>
            ...
            <div class="footer-col social-col">
                <div class="footer-heading-desktop">FOLLOW US</div>
...
function setupFooterAccordion() {
    ...
    toggles.forEach(toggle => {
        toggle.addEventListener('click', () => {
            // Mobile only behavior checks are handled in CSS via pointer-events, 
            // but we ensure logic is robust.
