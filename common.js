...
// *** മാറ്റം: ChatBot & Dealer WhatsApp ഓപ്ഷനുകൾ ***
function buildUserMenuHTML(settings) {
    // 1. ChatBot Number
    const chatbotNumber = "+15551386613"; 
    const chatbotLink = `https://wa.me/${chatbotNumber}`;

    // 2. Dealer WhatsApp Number (Settings-ൽ നിന്ന്)
    let dealerWhatsappHTML = '';
