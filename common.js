 ...
 * *** പുതിയത്: 'Promise.all' മാറ്റി സുരക്ഷിതമാക്കി ***
 */
export async function loadSiteSettings() {
    ...
    try {
        ...
        // *** മാറ്റം: 'Promise.all' മാറ്റി, ഓരോന്നും പ്രത്യേകം 'try...catch' ബ്ലോക്കിലാക്കി ***
        
        try {
            await buildHeader();
        } catch (e) {
            console.error("Error building header:", e);
        }
        
        try {
            await buildSideNav();
        } catch (e) {
            console.error("Error building side nav:", e);
        }
        
        try {
            await buildFooter();
        } catch (e) {
            console.error("Error building footer:", e);
        }
        
        try {
            await buildFloatingButtons();
        } catch (e) {
            console.error("Error building floating buttons:", e);
        }
        
    } catch (error) {
        console.error("Error during site initialization: ", error);
    } finally {
        // എല്ലാം കഴിഞ്ഞ ശേഷം ലോഡർ മറയ്ക്കുന്നു (എറർ ഉണ്ടായാലും ഇല്ലെങ്കിലും)
        if (preloader) {
