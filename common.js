    ...
    navElement.innerHTML = `
        ...
        <div class="side-nav-social">
            ...
            <a href="${settings.instagramUrl || '#'}" target="_blank" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.85s.012-3.584.07-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163m0-2.163C8.741 0 8.333.014 7.053.072 2.748.264.93 2.073.738 6.3C.68 7.58.666 8.004.666 12s.014 4.42.072 5.7c.196 4.227 2.004 6.036 6.3 6.228 1.28.058 1.688.072 4.947.072s3.667-.014 4.947-.072c4.227-.192 6.036-2.001 6.228-6.228.058-1.28.072-1.688.072-4.947s-.014-3.667-.072-4.947C23.064 2.073 21.256.264 16.953.072 15.667.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.88 1.44 1.44 0 0 0 0-2.88z"></path></svg>
            </a>
            <!-- **** പുതിയ ഫേസ്ബുക്ക് ഐക്കൺ **** -->
